...
public enum AppTheme {
    ...
    // MARK: - Tap Feedback (Apple HIG: respond on press-down, not release)
    public struct TapFeedbackButtonStyle: ButtonStyle {
        public init() {}
...
extension ButtonStyle where Self == AppTheme.TapFeedbackButtonStyle {
    public static var tapFeedback: AppTheme.TapFeedbackButtonStyle { .init() }
}
